  ...
  async updateStudent(id: string, data: any, user?: any) {
    ...
    return this.prisma.$transaction(async (tx) => {
      const biodata = await tx.biodata.update({
        ...
        data: {
          nik: nik !== undefined ? (nik?.trim() ? nik.trim() : null) : student.biodata.nik,
          noKk: noKk !== undefined ? (noKk?.trim() ? noKk.trim() : null) : student.biodata.noKk,
          nisn: nisn !== undefined ? (nisn?.trim() ? nisn.trim() : null) : student.biodata.nisn,
          nisLokal: nisLokal !== undefined ? (nisLokal?.trim() ? nisLokal.trim() : null) : student.biodata.nisLokal,
          noGlodemy: noGlodemy !== undefined ? (noGlodemy?.trim() ? noGlodemy.trim() : null) : student.biodata.noGlodemy,
          fullName: fullName !== undefined ? fullName : student.biodata.fullName,
          tempatLahir: tempatLahir !== undefined ? tempatLahir : student.biodata.tempatLahir,
          tanggalLahir: tanggalLahir !== undefined ? (tanggalLahir ? new Date(tanggalLahir) : null) : student.biodata.tanggalLahir,
          jenisKelamin: jenisKelamin !== undefined ? jenisKelamin : student.biodata.jenisKelamin,
          kewarganegaraan: kewarganegaraan !== undefined ? kewarganegaraan : student.biodata.kewarganegaraan,
          jumlahSaudara: jumlahSaudara !== undefined ? (jumlahSaudara !== '' && jumlahSaudara !== null ? Number(jumlahSaudara) : null) : student.biodata.jumlahSaudara,
          anakKe: anakKe !== undefined ? (anakKe !== '' && anakKe !== null ? Number(anakKe) : null) : student.biodata.anakKe,
          namaAyah: namaAyah !== undefined ? namaAyah : student.biodata.namaAyah,
          statusHidupAyah: statusHidupAyah !== undefined ? statusHidupAyah : student.biodata.statusHidupAyah,
          nikAyah: nikAyah !== undefined ? nikAyah : student.biodata.nikAyah,
          tempatLahirAyah: tempatLahirAyah !== undefined ? tempatLahirAyah : student.biodata.tempatLahirAyah,
          tanggalLahirAyah: tanggalLahirAyah !== undefined ? (tanggalLahirAyah ? new Date(tanggalLahirAyah) : null) : student.biodata.tanggalLahirAyah,
          pekerjaanAyah: pekerjaanAyah !== undefined ? pekerjaanAyah : student.biodata.pekerjaanAyah,
          pendidikanAyah: pendidikanAyah !== undefined ? pendidikanAyah : student.biodata.pendidikanAyah,
          penghasilanAyah: penghasilanAyah !== undefined ? penghasilanAyah : student.biodata.penghasilanAyah,
          namaIbu: namaIbu !== undefined ? namaIbu : student.biodata.namaIbu,
          statusHidupIbu: statusHidupIbu !== undefined ? statusHidupIbu : student.biodata.statusHidupIbu,
          nikIbu: nikIbu !== undefined ? nikIbu : student.biodata.nikIbu,
          tempatLahirIbu: tempatLahirIbu !== undefined ? tempatLahirIbu : student.biodata.tempatLahirIbu,
          tanggalLahirIbu: tanggalLahirIbu !== undefined ? (tanggalLahirIbu ? new Date(tanggalLahirIbu) : null) : student.biodata.tanggalLahirIbu,
          pekerjaanIbu: pekerjaanIbu !== undefined ? pekerjaanIbu : student.biodata.pekerjaanIbu,
          pendidikanIbu: pendidikanIbu !== undefined ? pendidikanIbu : student.biodata.pendidikanIbu,
          penghasilanIbu: penghasilanIbu !== undefined ? penghasilanIbu : student.biodata.penghasilanIbu,
          address: address !== undefined ? address : student.biodata.address,
          phone: phone !== undefined ? phone : student.biodata.phone,
          kontakDaruratNama: kontakDaruratNama !== undefined ? kontakDaruratNama : student.biodata.kontakDaruratNama,
          kontakDaruratTelp: kontakDaruratTelp !== undefined ? kontakDaruratTelp : student.biodata.kontakDaruratTelp,
          kontakDaruratHubungan: kontakDaruratHubungan !== undefined ? kontakDaruratHubungan : student.biodata.kontakDaruratHubungan,
          alamatProvId: alamatProvId !== undefined ? alamatProvId : student.biodata.alamatProvId,
          alamatProvName: alamatProvName !== undefined ? alamatProvName : student.biodata.alamatProvName,
          alamatKabId: alamatKabId !== undefined ? alamatKabId : student.biodata.alamatKabId,
          alamatKabName: alamatKabName !== undefined ? alamatKabName : student.biodata.alamatKabName,
          alamatKecId: alamatKecId !== undefined ? alamatKecId : student.biodata.alamatKecId,
          alamatKecName: alamatKecName !== undefined ? alamatKecName : student.biodata.alamatKecName,
          alamatKelId: alamatKelId !== undefined ? alamatKelId : student.biodata.alamatKelId,
          alamatKelName: alamatKelName !== undefined ? alamatKelName : student.biodata.alamatKelName,
          alamatJalan: alamatJalan !== undefined ? alamatJalan : student.biodata.alamatJalan
        }
      });
      ...
      const updatedStudent = await tx.student.update({
        where: { id },
        data: {
          wilayahId: targetWilayahId !== undefined ? targetWilayahId : student.wilayahId,
